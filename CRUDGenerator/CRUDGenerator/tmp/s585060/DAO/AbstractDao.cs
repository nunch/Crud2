...
namespace PerennisationSPI.Dao
{
    ...
    {
        public static PerennisationSPIEntities db = new PerennisationSPIEntities();
        public static object dbLock = new object();
        public static string ConnectionString;
        public AbstractDao()
        {
            //this.ConnectionString = ConfigurationManager.ConnectionStrings["PerennisationSPI"].ConnectionString;
        }
