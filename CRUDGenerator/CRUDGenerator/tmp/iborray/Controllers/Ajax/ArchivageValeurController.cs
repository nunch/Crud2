...
{
    public class ArchivageValeurController : Controller
    {
        ...
        [HttpPost]
        public string AddArchivageValeur(ArchivageValeur archivageValeur)
        {
            MessageModel msg = null;
            MessageModel msgAdd = ArchivageValeurInstance.AddArchivageValeur(ref archivageValeur);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveArchivageValeur(int Id_ArchivageValeur)
        {
            MessageModel msg = ArchivageValeurInstance.RemoveArchivageValeur(Id_ArchivageValeur);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateArchivageValeur(ArchivageValeur archivageValeur)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ArchivageValeurInstance.UpdateArchivageValeur(archivageValeur);
        ...
        [HttpPost]
        public string GetArchivageValeurById(int Id_ArchivageValeur)
        {
            MessageModel msg = ArchivageValeurInstance.GetArchivageValeurById(Id_ArchivageValeur);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllArchivageValeur()
        {
            MessageModel msg = ArchivageValeurInstance.GetAllArchivageValeur();
            return JsonConvert.SerializeObject(msg);
        }
