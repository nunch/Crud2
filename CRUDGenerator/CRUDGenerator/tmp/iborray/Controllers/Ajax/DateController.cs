...
namespace GEEC.Controllers.Ajax
{
    public class DateController : Controller
    {
        ...
        public string AddDate(Date date)
        {
            ...
            MessageModel msgAdd = DateInstance.AddDate(ref date);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveDate(int Id_Date)
        {
            MessageModel msg = DateInstance.RemoveDate(Id_Date);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = DateInstance.UpdateDate(date);
        ...
        [HttpPost]
        public string GetDateById(int Id_Date)
        {
            MessageModel msg = DateInstance.GetDateById(Id_Date);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = DateInstance.GetAllDate();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = DateInstance.GetByTypeId(TypeId);
            return JsonConvert.SerializeObject(msg);
        }
