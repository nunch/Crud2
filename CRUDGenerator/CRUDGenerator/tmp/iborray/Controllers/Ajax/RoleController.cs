...
namespace GEEC.Controllers.Ajax
{
    public class RoleController : Controller
    {
        ...
        public string AddRole(Role role)
        {
            ...
            MessageModel msgAdd = RoleInstance.AddRole(ref role);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveRole(int Id_Role)
        {
            MessageModel msg = RoleInstance.RemoveRole(Id_Role);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = RoleInstance.UpdateRole(role);
        ...
        [HttpPost]
        public string GetRoleById(int Id_Role)
        {
            MessageModel msg = RoleInstance.GetRoleById(Id_Role);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = RoleInstance.GetAllRole();
            return JsonConvert.SerializeObject(msg);
        }
