...
{
    public class EssayeurNewEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllEssayeurNewEssaisList()
        {
            MessageModel msg = EssayeurNewEssaisListInstance.GetAllEssayeurNewEssaisList();
