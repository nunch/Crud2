...
{
    public class SupplyChainEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllSupplyChainEssaisList()
        {
            MessageModel msg = SupplyChainEssaisListInstance.GetAllSupplyChainEssaisList();
