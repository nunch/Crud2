...
namespace GEEC.Controllers.Ajax
{
    public class UtilisateurController : Controller
    {
        ...
        public string AddUtilisateur(Utilisateur utilisateur)
        {
            ...
            MessageModel msgAdd = UtilisateurInstance.AddUtilisateur(ref utilisateur);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveUtilisateur(int Id_Utilisateur)
        {
            MessageModel msg = UtilisateurInstance.RemoveUtilisateur(Id_Utilisateur);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = UtilisateurInstance.UpdateUtilisateur(utilisateur);
        ...
        [HttpPost]
        public string GetUtilisateurById(int Id_Utilisateur)
        {
            MessageModel msg = UtilisateurInstance.GetUtilisateurById(Id_Utilisateur);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = UtilisateurInstance.GetAllUtilisateur();
            return JsonConvert.SerializeObject(msg);
        }
