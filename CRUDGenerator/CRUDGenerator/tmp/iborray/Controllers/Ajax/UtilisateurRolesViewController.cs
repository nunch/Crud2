...
{
    public class UtilisateurRolesViewController : Controller
    {
        ...
        [HttpPost]
        public string GetAllUtilisateurRolesView()
        {
            MessageModel msg = UtilisateurRolesViewInstance.GetAllUtilisateurRolesView();
