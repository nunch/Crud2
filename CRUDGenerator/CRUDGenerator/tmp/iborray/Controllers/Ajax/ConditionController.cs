...
namespace GEEC.Controllers.Ajax
{
    public class ConditionController : Controller
    {
        ...
        public string AddCondition(Condition condition)
        {
            ...
            MessageModel msgAdd = ConditionInstance.AddCondition(ref condition);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveCondition(int Id_Condition)
        {
            MessageModel msg = ConditionInstance.RemoveCondition(Id_Condition);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = ConditionInstance.UpdateCondition(condition);
        ...
        [HttpPost]
        public string GetConditionById(int Id_Condition)
        {
            MessageModel msg = ConditionInstance.GetConditionById(Id_Condition);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ConditionInstance.GetAllCondition();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ConditionInstance.GetByRapportId(RapportId);
            return JsonConvert.SerializeObject(msg);
        }
