...
{
    public class EssayeurEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllEssayeurEssaisList()
        {
            MessageModel msg = EssayeurEssaisListInstance.GetAllEssayeurEssaisList();
