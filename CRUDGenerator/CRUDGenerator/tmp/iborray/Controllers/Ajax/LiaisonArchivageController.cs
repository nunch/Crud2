...
{
    public class LiaisonArchivageController : Controller
    {
        ...
        [HttpPost]
        public string AddLiaisonArchivage(LiaisonArchivage liaisonArchivage)
        {
            MessageModel msg = null;
            MessageModel msgAdd = LiaisonArchivageInstance.AddLiaisonArchivage(ref liaisonArchivage);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveLiaisonArchivage(int Id_LiaisonArchivage)
        {
            MessageModel msg = LiaisonArchivageInstance.RemoveLiaisonArchivage(Id_LiaisonArchivage);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateLiaisonArchivage(LiaisonArchivage liaisonArchivage)
        {
            MessageModel msg = null;
            MessageModel updateMsg = LiaisonArchivageInstance.UpdateLiaisonArchivage(liaisonArchivage);
        ...
        [HttpPost]
        public string GetLiaisonArchivageById(int Id_LiaisonArchivage)
        {
            MessageModel msg = LiaisonArchivageInstance.GetLiaisonArchivageById(Id_LiaisonArchivage);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllLiaisonArchivage()
        {
            MessageModel msg = LiaisonArchivageInstance.GetAllLiaisonArchivage();
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByArchivageChampId(int ArchivageChampId)
        {
            MessageModel msg = LiaisonArchivageInstance.GetByArchivageChampId(ArchivageChampId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByArchivageValeurId(int ArchivageValeurId)
        {
            MessageModel msg = LiaisonArchivageInstance.GetByArchivageValeurId(ArchivageValeurId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByArchivageChampId_ArchivageValeurId(int ArchivageChampId, int ArchivageValeurId)
        {
            MessageModel msg = LiaisonArchivageInstance.GetByArchivageChampId_ArchivageValeurId(ArchivageChampId, ArchivageValeurId);
            return JsonConvert.SerializeObject(msg);
        }
