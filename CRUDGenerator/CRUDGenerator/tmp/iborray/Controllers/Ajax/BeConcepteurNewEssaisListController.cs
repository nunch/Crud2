...
{
    public class BeConcepteurNewEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllBeConcepteurNewEssaisList()
        {
            MessageModel msg = BeConcepteurNewEssaisListInstance.GetAllBeConcepteurNewEssaisList();
