...
{
    public class DescriptifController : Controller
    {
        ...
        [HttpPost]
        public string AddDescriptif(Descriptif descriptif)
        {
            MessageModel msg = null;
            MessageModel msgAdd = DescriptifInstance.AddDescriptif(ref descriptif);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveDescriptif(int Id_Descriptif)
        {
            MessageModel msg = DescriptifInstance.RemoveDescriptif(Id_Descriptif);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateDescriptif(Descriptif descriptif)
        {
            MessageModel msg = null;
            MessageModel updateMsg = DescriptifInstance.UpdateDescriptif(descriptif);
        ...
        [HttpPost]
        public string GetDescriptifById(int Id_Descriptif)
        {
            MessageModel msg = DescriptifInstance.GetDescriptifById(Id_Descriptif);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllDescriptif()
        {
            MessageModel msg = DescriptifInstance.GetAllDescriptif();
            return JsonConvert.SerializeObject(msg);
        }
