...
{
    public class AssoEssaiDemandeEssaiController : Controller
    {
        ...
        [HttpPost]
        public string AddAssoEssaiDemandeEssai(AssoEssaiDemandeEssai assoEssaiDemandeEssai)
        {
            MessageModel msg = null;
            MessageModel msgAdd = AssoEssaiDemandeEssaiInstance.AddAssoEssaiDemandeEssai(ref assoEssaiDemandeEssai);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveAssoEssaiDemandeEssai(int Id_AssoEssaiDemandeEssai)
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.RemoveAssoEssaiDemandeEssai(Id_AssoEssaiDemandeEssai);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateAssoEssaiDemandeEssai(AssoEssaiDemandeEssai assoEssaiDemandeEssai)
        {
            MessageModel msg = null;
            MessageModel updateMsg = AssoEssaiDemandeEssaiInstance.UpdateAssoEssaiDemandeEssai(assoEssaiDemandeEssai);
        ...
        [HttpPost]
        public string GetAssoEssaiDemandeEssaiById(int Id_AssoEssaiDemandeEssai)
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.GetAssoEssaiDemandeEssaiById(Id_AssoEssaiDemandeEssai);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllAssoEssaiDemandeEssai()
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.GetAllAssoEssaiDemandeEssai();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.GetByDemandeEssaiId(DemandeEssaiId);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.GetByEssaiId(EssaiId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByDemandeEssaiId_EssaiId(int DemandeEssaiId, int EssaiId)
        {
            MessageModel msg = AssoEssaiDemandeEssaiInstance.GetByDemandeEssaiId_EssaiId(DemandeEssaiId, EssaiId);
            return JsonConvert.SerializeObject(msg);
        }
