...
namespace GEEC.Controllers.Ajax
{
    public class PermissionController : Controller
    {
        ...
        public string AddPermission(Permission permission)
        {
            ...
            MessageModel msgAdd = PermissionInstance.AddPermission(ref permission);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemovePermission(int Id_Permission)
        {
            MessageModel msg = PermissionInstance.RemovePermission(Id_Permission);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = PermissionInstance.UpdatePermission(permission);
        ...
        [HttpPost]
        public string GetPermissionById(int Id_Permission)
        {
            MessageModel msg = PermissionInstance.GetPermissionById(Id_Permission);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = PermissionInstance.GetAllPermission();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = PermissionInstance.GetByRoleId(RoleId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByChampId(int ChampId)
        {
            MessageModel msg = PermissionInstance.GetByChampId(ChampId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByRoleId_ChampId(int RoleId, int ChampId)
        {
            MessageModel msg = PermissionInstance.GetByRoleId_ChampId(RoleId, ChampId);
            return JsonConvert.SerializeObject(msg);
        }
