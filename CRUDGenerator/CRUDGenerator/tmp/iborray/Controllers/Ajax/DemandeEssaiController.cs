...
{
    public class DemandeEssaiController : Controller
    {
        ...
        [HttpPost]
        public string AddDemandeEssai(DemandeEssai demandeEssai)
        {
            MessageModel msg = null;
            MessageModel msgAdd = DemandeEssaiInstance.AddDemandeEssai(ref demandeEssai);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveDemandeEssai(int Id_DemandeEssai)
        {
            MessageModel msg = DemandeEssaiInstance.RemoveDemandeEssai(Id_DemandeEssai);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateDemandeEssai(DemandeEssai demandeEssai)
        {
            MessageModel msg = null;
            MessageModel updateMsg = DemandeEssaiInstance.UpdateDemandeEssai(demandeEssai);
        ...
        [HttpPost]
        public string GetDemandeEssaiById(int Id_DemandeEssai)
        {
            MessageModel msg = DemandeEssaiInstance.GetDemandeEssaiById(Id_DemandeEssai);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllDemandeEssai()
        {
            MessageModel msg = DemandeEssaiInstance.GetAllDemandeEssai();
            return JsonConvert.SerializeObject(msg);
        }
