...
{
    public class SupplyChainNewEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllSupplyChainNewEssaisList()
        {
            MessageModel msg = SupplyChainNewEssaisListInstance.GetAllSupplyChainNewEssaisList();
