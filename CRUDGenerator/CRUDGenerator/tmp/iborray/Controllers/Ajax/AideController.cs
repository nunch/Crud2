...
namespace GEEC.Controllers.Ajax
{
    public class AideController : Controller
    {
        ...
        [HttpPost]
        public string AddAide(Aide aide)
        {
            MessageModel msg = null;
            MessageModel msgAdd = AideInstance.AddAide(ref aide);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveAide(int Id_Aide)
        {
            MessageModel msg = AideInstance.RemoveAide(Id_Aide);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateAide(Aide aide)
        {
            MessageModel msg = null;
            MessageModel updateMsg = AideInstance.UpdateAide(aide);
        ...
        [HttpPost]
        public string GetAideById(int Id_Aide)
        {
            MessageModel msg = AideInstance.GetAideById(Id_Aide);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllAide()
        {
            MessageModel msg = AideInstance.GetAllAide();
            return JsonConvert.SerializeObject(msg);
        }
