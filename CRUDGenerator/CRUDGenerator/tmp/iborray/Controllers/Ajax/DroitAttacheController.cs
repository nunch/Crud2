...
{
    public class DroitAttacheController : Controller
    {
        ...
        [HttpPost]
        public string AddDroitAttache(DroitAttache droitAttache)
        {
            MessageModel msg = null;
            MessageModel msgAdd = DroitAttacheInstance.AddDroitAttache(ref droitAttache);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveDroitAttache(int Id_DroitAttache)
        {
            MessageModel msg = DroitAttacheInstance.RemoveDroitAttache(Id_DroitAttache);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateDroitAttache(DroitAttache droitAttache)
        {
            MessageModel msg = null;
            MessageModel updateMsg = DroitAttacheInstance.UpdateDroitAttache(droitAttache);
        ...
        [HttpPost]
        public string GetDroitAttacheById(int Id_DroitAttache)
        {
            MessageModel msg = DroitAttacheInstance.GetDroitAttacheById(Id_DroitAttache);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllDroitAttache()
        {
            MessageModel msg = DroitAttacheInstance.GetAllDroitAttache();
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByAttacheId(int AttacheId)
        {
            MessageModel msg = DroitAttacheInstance.GetByAttacheId(AttacheId);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = DroitAttacheInstance.GetByRoleId(RoleId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByAttacheId_RoleId(int AttacheId, int RoleId)
        {
            MessageModel msg = DroitAttacheInstance.GetByAttacheId_RoleId(AttacheId, RoleId);
            return JsonConvert.SerializeObject(msg);
        }
