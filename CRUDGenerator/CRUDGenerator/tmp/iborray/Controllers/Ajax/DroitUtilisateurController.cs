...
{
    public class DroitUtilisateurController : Controller
    {
        ...
        [HttpPost]
        public string AddDroitUtilisateur(DroitUtilisateur droitUtilisateur)
        {
            MessageModel msg = null;
            MessageModel msgAdd = DroitUtilisateurInstance.AddDroitUtilisateur(ref droitUtilisateur);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveDroitUtilisateur(int Id_DroitUtilisateur)
        {
            MessageModel msg = DroitUtilisateurInstance.RemoveDroitUtilisateur(Id_DroitUtilisateur);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateDroitUtilisateur(DroitUtilisateur droitUtilisateur)
        {
            MessageModel msg = null;
            MessageModel updateMsg = DroitUtilisateurInstance.UpdateDroitUtilisateur(droitUtilisateur);
        ...
        [HttpPost]
        public string GetDroitUtilisateurById(int Id_DroitUtilisateur)
        {
            MessageModel msg = DroitUtilisateurInstance.GetDroitUtilisateurById(Id_DroitUtilisateur);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllDroitUtilisateur()
        {
            MessageModel msg = DroitUtilisateurInstance.GetAllDroitUtilisateur();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = DroitUtilisateurInstance.GetByUtilisateurId(UtilisateurId);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = DroitUtilisateurInstance.GetByRoleId(RoleId);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByUtilisateurId_RoleId(int UtilisateurId, int RoleId)
        {
            MessageModel msg = DroitUtilisateurInstance.GetByUtilisateurId_RoleId(UtilisateurId, RoleId);
            return JsonConvert.SerializeObject(msg);
        }
