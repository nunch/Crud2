...
{
    public class MarqueTechniqueNewEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllMarqueTechniqueNewEssaisList()
        {
            MessageModel msg = MarqueTechniqueNewEssaisListInstance.GetAllMarqueTechniqueNewEssaisList();
