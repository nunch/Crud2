...
{
    public class ArchivageChampController : Controller
    {
        ...
        [HttpPost]
        public string AddArchivageChamp(ArchivageChamp archivageChamp)
        {
            MessageModel msg = null;
            MessageModel msgAdd = ArchivageChampInstance.AddArchivageChamp(ref archivageChamp);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveArchivageChamp(int Id_ArchivageChamp)
        {
            MessageModel msg = ArchivageChampInstance.RemoveArchivageChamp(Id_ArchivageChamp);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateArchivageChamp(ArchivageChamp archivageChamp)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ArchivageChampInstance.UpdateArchivageChamp(archivageChamp);
        ...
        [HttpPost]
        public string GetArchivageChampById(int Id_ArchivageChamp)
        {
            MessageModel msg = ArchivageChampInstance.GetArchivageChampById(Id_ArchivageChamp);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllArchivageChamp()
        {
            MessageModel msg = ArchivageChampInstance.GetAllArchivageChamp();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ArchivageChampInstance.GetByRoleId(RoleId);
            return JsonConvert.SerializeObject(msg);
        }
