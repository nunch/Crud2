...
{
    public class ChampsCommunController : Controller
    {
        ...
        [HttpPost]
        public string AddChampsCommun(ChampsCommun champsCommun)
        {
            MessageModel msg = null;
            MessageModel msgAdd = ChampsCommunInstance.AddChampsCommun(ref champsCommun);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveChampsCommun(int Id_ChampsCommun)
        {
            MessageModel msg = ChampsCommunInstance.RemoveChampsCommun(Id_ChampsCommun);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateChampsCommun(ChampsCommun champsCommun)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ChampsCommunInstance.UpdateChampsCommun(champsCommun);
        ...
        [HttpPost]
        public string GetChampsCommunById(int Id_ChampsCommun)
        {
            MessageModel msg = ChampsCommunInstance.GetChampsCommunById(Id_ChampsCommun);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllChampsCommun()
        {
            MessageModel msg = ChampsCommunInstance.GetAllChampsCommun();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ChampsCommunInstance.GetByEssaiId(EssaiId);
            return JsonConvert.SerializeObject(msg);
        }
