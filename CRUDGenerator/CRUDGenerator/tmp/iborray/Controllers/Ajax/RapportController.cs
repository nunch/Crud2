...
namespace GEEC.Controllers.Ajax
{
    public class RapportController : Controller
    {
        ...
        [HttpPost]
        public string AddRapport(Rapport rapport)
        {
            MessageModel msg = null;
            MessageModel msgAdd = RapportInstance.AddRapport(ref rapport);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveRapport(int Id_Rapport)
        {
            MessageModel msg = RapportInstance.RemoveRapport(Id_Rapport);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateRapport(Rapport rapport)
        {
            MessageModel msg = null;
            MessageModel updateMsg = RapportInstance.UpdateRapport(rapport);
        ...
        [HttpPost]
        public string GetRapportById(int Id_Rapport)
        {
            MessageModel msg = RapportInstance.GetRapportById(Id_Rapport);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetAllRapport()
        {
            MessageModel msg = RapportInstance.GetAllRapport();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = RapportInstance.GetByUtilisateurId(UtilisateurId);
            return JsonConvert.SerializeObject(msg);
        }
