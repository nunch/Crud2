...
namespace GEEC.Controllers.Ajax
{
    public class ChampController : Controller
    {
        ...
        [HttpPost]
        public string AddChamp(Champ champ)
        {
            MessageModel msg = null;
            MessageModel msgAdd = ChampInstance.AddChamp(ref champ);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveChamp(int Id_Champ)
        {
            MessageModel msg = ChampInstance.RemoveChamp(Id_Champ);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateChamp(Champ champ)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ChampInstance.UpdateChamp(champ);
        ...
        [HttpPost]
        public string GetChampById(int Id_Champ)
        {
            MessageModel msg = ChampInstance.GetChampById(Id_Champ);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ChampInstance.GetAllChamp();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ChampInstance.GetByRoleId(RoleId);
            return JsonConvert.SerializeObject(msg);
        }
