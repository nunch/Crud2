...
{
    public class UserPermissionChampListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllUserPermissionChampList()
        {
            MessageModel msg = UserPermissionChampListInstance.GetAllUserPermissionChampList();
