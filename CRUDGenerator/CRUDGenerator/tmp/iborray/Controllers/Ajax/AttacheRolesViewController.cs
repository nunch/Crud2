...
{
    public class AttacheRolesViewController : Controller
    {
        ...
        [HttpPost]
        public string GetAllAttacheRolesView()
        {
            MessageModel msg = AttacheRolesViewInstance.GetAllAttacheRolesView();
