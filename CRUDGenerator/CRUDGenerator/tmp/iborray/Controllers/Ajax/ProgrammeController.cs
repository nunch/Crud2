...
namespace GEEC.Controllers.Ajax
{
    public class ProgrammeController : Controller
    {
        ...
        public string AddProgramme(Programme programme)
        {
            ...
            MessageModel msgAdd = ProgrammeInstance.AddProgramme(ref programme);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveProgramme(int Id_Programme)
        {
            MessageModel msg = ProgrammeInstance.RemoveProgramme(Id_Programme);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateProgramme(Programme programme)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ProgrammeInstance.UpdateProgramme(programme);
        ...
        [HttpPost]
        public string GetProgrammeById(int Id_Programme)
        {
            MessageModel msg = ProgrammeInstance.GetProgrammeById(Id_Programme);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ProgrammeInstance.GetAllProgramme();
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ProgrammeInstance.GetByProgrammeId(ProgrammeId);
            return JsonConvert.SerializeObject(msg);
        }
