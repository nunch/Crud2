...
{
    public class MarqueTechniqueEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllMarqueTechniqueEssaisList()
        {
            MessageModel msg = MarqueTechniqueEssaisListInstance.GetAllMarqueTechniqueEssaisList();
