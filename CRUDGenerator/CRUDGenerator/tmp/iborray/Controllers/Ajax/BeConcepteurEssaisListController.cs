...
{
    public class BeConcepteurEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllBeConcepteurEssaisList()
        {
            MessageModel msg = BeConcepteurEssaisListInstance.GetAllBeConcepteurEssaisList();
