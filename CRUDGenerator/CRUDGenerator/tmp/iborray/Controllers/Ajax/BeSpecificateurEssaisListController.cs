...
{
    public class BeSpecificateurEssaisListController : Controller
    {
        ...
        [HttpPost]
        public string GetAllBeSpecificateurEssaisList()
        {
            MessageModel msg = BeSpecificateurEssaisListInstance.GetAllBeSpecificateurEssaisList();
