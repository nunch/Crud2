...
{
    public class ColonneController : Controller
    {
        ...
        [HttpPost]
        public string AddColonne(Colonne colonne)
        {
            MessageModel msg = null;
            MessageModel msgAdd = ColonneInstance.AddColonne(ref colonne);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveColonne(int Id_Colonne)
        {
            MessageModel msg = ColonneInstance.RemoveColonne(Id_Colonne);
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string UpdateColonne(Colonne colonne)
        {
            MessageModel msg = null;
            MessageModel updateMsg = ColonneInstance.UpdateColonne(colonne);
        ...
        [HttpPost]
        public string GetColonneById(int Id_Colonne)
        {
            MessageModel msg = ColonneInstance.GetColonneById(Id_Colonne);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = ColonneInstance.GetAllColonne();
            return JsonConvert.SerializeObject(msg);
        }

        [HttpPost]
        public string GetByRapportId(int RapportId)
        {
            MessageModel msg = ColonneInstance.GetByRapportId(RapportId);
            return JsonConvert.SerializeObject(msg);
        }
