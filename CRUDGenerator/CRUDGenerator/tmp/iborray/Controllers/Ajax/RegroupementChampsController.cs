...
{
    public class RegroupementChampsController : Controller
    {
        ...
        [HttpPost]
        public string GetAllRegroupementChamps()
        {
            MessageModel msg = RegroupementChampsInstance.GetAllRegroupementChamps();
