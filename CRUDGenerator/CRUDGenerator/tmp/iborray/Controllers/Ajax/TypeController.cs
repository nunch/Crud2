...
namespace GEEC.Controllers.Ajax
{
    public class TypeController : Controller
    {
        ...
        public string AddType(Type type)
        {
            ...
            MessageModel msgAdd = TypeInstance.AddType(ref type);
            
            return JsonConvert.SerializeObject(msgAdd);
        }

        [HttpPost]
        public string RemoveType(int Id_Type)
        {
            MessageModel msg = TypeInstance.RemoveType(Id_Type);
        ...
        {
            MessageModel msg = null;
            MessageModel updateMsg = TypeInstance.UpdateType(type);
        ...
        [HttpPost]
        public string GetTypeById(int Id_Type)
        {
            MessageModel msg = TypeInstance.GetTypeById(Id_Type);
            return JsonConvert.SerializeObject(msg);
        }
        ...
        {
            MessageModel msg = TypeInstance.GetAllType();
            return JsonConvert.SerializeObject(msg);
        }
